...
class Master:
    ...
    def start_remote_logging_server(self):
        ...
        try:
            ...
            llogger.debug("Started logging server for swarm: %s on interface: %s with hostname: %s:%s", self._swarm_uuid,
                          self._remote_logging_server.interface, self._remote_logging_server.hostname,
