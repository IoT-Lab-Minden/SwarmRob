...
class TestDockerContainerList(TestCase):
    def setUp(self):
        self.container_list = docker_container_list.DockerContainerList()
        self.container_list.append(DummyContainer())
        self.container_list.append(DummyContainer("running"))
